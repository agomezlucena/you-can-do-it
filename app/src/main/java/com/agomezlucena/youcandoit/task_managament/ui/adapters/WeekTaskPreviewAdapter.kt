...
class WeekTaskPreviewAdapter(
        private val viewModel:ThisWeekTasksViewModel,
        private val context: Context,
        private var list: List<Task>,
        private val navController: NavController) :
RecyclerView.Adapter<WeekTaskPreviewAdapter.ViewHolder>() {

    inner class ViewHolder (private val binding: LayoutTaskPreviewBinding) : RecyclerView.ViewHolder(binding.root){
        ...
        fun bindData(task: Task){
            ...
            binding.finishedStatus.setOnCheckedChangeListener{
                _, isChecked ->
                if (isChecked){
                    task.finished = true
